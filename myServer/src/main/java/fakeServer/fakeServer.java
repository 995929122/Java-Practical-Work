...
public class fakeServer {
    private static final String SENT_LINES_FILE = "src/main/java/fakeServer/mastered.txt";
    public static final String WRONG_WORDS_FILE = "src/main/java/fakeServer/WrongWords.txt";
    public static final String MASTER_WORDS = "src/main/java/fakeServer/mastered.txt";
    public static final String TEXT_FILE = "src/main/java/fakeServer/sorted.txt";
